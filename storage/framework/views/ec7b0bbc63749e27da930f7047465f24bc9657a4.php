...
<div class="container-fluid white-bg">
       <div class="col-md-12 fbadetails"><h3 class="mrg-btm">CRM FBA</h3>
        ...
        <a class="btn btn-primary" style="float: right;" id="btnaddno" data-toggle="modal" data-target="#myModal" onclick="savealternateno(<?php echo e($val->FBAID); ?>)">ADD ALTERNATE NO</a>
      </div>
       ...
       <div class="fbadetails col-md-12 col-md-offset-2">
        ...
        <tr>
         ...
         <th>FBA MOBILE NO:</th>
         <td><?php echo e($val->MobiNumb1); ?> / <?php echo e($val->MobiNumb2); ?></td>
        </tr>
           ...
           <div class="form-group row">
            ...
            <div class="col-md-6">
              <select class="form-control"data-style="btn-success" name="ddlconnection" id="ddlconnection" required>
                ...
                <?php $__currentLoopData = $condata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <option value="<?php echo e($val->id); ?>"><?php echo e($val->connection_type); ?></option>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </select>
            </div>
          </div>                 
...
<div id="myModal" class="modal fade" role="dialog">
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <form method="post" action="<?php echo e(url('save-alernate-no')); ?>">    
      <?php echo e(csrf_field()); ?>
