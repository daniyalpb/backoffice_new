...
<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
<p class="alert alert-danger"><?php echo e(Session::get('message1')); ?></p>
</div>
<?php endif; ?>
<style type="text/css">
  .profile {
...
<button class="common-btn" id="btnshowpospcity" style="margin-top: 25px" onclick="getpospdonefbaoncity()">Show</button>    
  ...
  <form id="formsavefbalist" method="post" action="<?php echo e(URL::to('insert-fba-communication')); ?>">
  ...
  <div class="col-sm-6 col-xs-12 col-md-12 form-padding">  
    <label>SMS Header:</label>
     ...
     <option value="<?php echo e($val->SMSTemplateId); ?>"><?php echo e($val->Header); ?></option>
  ...
  <textarea style="padding:10px; height:200px;"  id="txtsms"  name="txtsms" class="form-control"> </textarea>
    ...
    <div class="col-sm-6 col-xs-12 form-padding col-md-12">  
     ...
     <option value="" >--select--</option>
      <option value="other" >Other</option>
     <?php $__currentLoopData = $mailsub; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
     <option value="<?php echo e($val->mail_tamplate_id); ?>" ><?php echo e($val->subject); ?></option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
     </select>
      <div id="divdatemail">
     <label>Schedule Date Time:</label>
  ...
  <textarea style="padding:10px; height:200px;"  id="txtmail"  name="txtmail" class="form-control"> </textarea>
   ...
   <div class="col-md-12" id="Divpushnotify" style="display: none;">
    ...
    <div class="col-sm-6 col-xs-12 form-padding col-md-12">  
     ...
     <option value="<?php echo e($val->MessageId); ?>" ><?php echo e($val->NotificationTitle); ?></option>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
     </select>
...
if ($("#txttodate").val()!='' && $("#txtfromdate").val()!='' && $("#txtcityall").val()!=''||$("#txtcity").val()!=''){
  ...
  var v_token = "<?php echo e(csrf_token()); ?>";
     $.ajax({
             url:"<?php echo e(URL::to('get-fba-by-city')); ?>",
             type: "POST", 
...
function getfbaonregdate()
{
 ...
 var cityname=$("#txtcity").val();
  ...
  var v_token = "<?php echo e(csrf_token()); ?>";
     $.ajax({
             url: "<?php echo e(URL::to('get-fba-by-city-paid-date')); ?>",
             type: "POST",    
             data:{"_token":v_token,"todate":todate,"fromdate":fromdate,"cityname":cityname},         
             success:function(DATA) 
             {      
...
if($("#txtcity").val()!=''){
 ...
 if($("#txtcity").val()!='' || $("#txtcityall").val()!='')
  ...
  //alert(v_token);
      $.ajax({
           type: "POST",   
             url:"<?php echo e(URL::to('get-posp-done-fba-on-city')); ?>",             
