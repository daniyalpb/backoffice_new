...
{
 $.ajax({ 
   url: "<?php echo e(URL::to('providerlist')); ?>",
   method:"POST",
...
{ 
 ...
 $("#btnbook").click(function(){
   ...
   $.ajax({ 
   url: "<?php echo e(URL::to('Health-Assure-Partner')); ?>",
   method:"POST",
   data: $('#formprovidelist').serialize(),
  success: function(msg)  
   {
...
<div class="col-md-12">
  <table class="table table-bordered tbl2 box-shadow">
    <tbody>
      <tr>
        <td><p><b>Basic Profile</b></p><h5 class="text-danger-clr"><?php echo e($_GET["tcount"]); ?>Tests</h5> </td>
        <td colspan="2"><p class="text-center"><b>ACTUAL COST</b></p> <span class="amount amunt1">₹ <strike><?php echo e($_GET["MRP"]); ?></strike></span></td>
        <td colspan="2"><p class="text-center"><b>OFFER COST</b></p> <span class="amount">₹ <?php echo e($_GET["OfferPrice"]); ?></span></td>
...
<input type="hidden" name="txtPackName" id="txtPackName" value="<?php echo e($_GET["PackName"]); ?>">
<input type="hidden" name="txtfbaname" id="txtfbaname" value="<?php echo e($_GET["fbaname"]); ?>">

<input type="hidden" name="txtfbaid" id="txtfbaid" value="<?php echo e($_GET["fbaid"]); ?>">
<input type="hidden" name="txtPackcode" id="txtPackcode" value="<?php echo e($_GET["Packcode"]); ?>">
<input type="hidden" name="txttcount" id="txttcount" value="<?php echo e($_GET["tcount"]); ?>">
<input type="hidden" name="txtMRP" id="txtMRP" value="<?php echo e($_GET["MRP"]); ?>">
<input type="hidden" name="txtOfferPrice" id="txtOfferPrice" value="<?php echo e($_GET["OfferPrice"]); ?>">
<input type="hidden" name="txthomevisit" id="txthomevisit" value="<?php echo e($_GET["homevisit"]); ?>">
<input type="hidden" name="txtfasting" id="txtfasting" value="<?php echo e($_GET["fasting"]); ?>">
<input type="hidden" name="latitude" id="latitude" value="<?php echo e($_GET["latitude"]); ?>">
<input type="hidden" name="longitude" id="longitude" value="<?php echo e($_GET["longitude"]); ?>">
...
<input type="hidden" name="txtID" id="txtID" value="<?php echo e($_GET["ID"]); ?>">
