...
<body>
	<table width="600" cellpadding="0" cellspacing="0" border="0" align="center" bgcolor="#fff" style="border:1px solid #d4d4d4;">
		<tr>
			<td><img src="<?php echo e(url('images/Template-4.jpg')); ?>"/></td>
		</tr>
		<tr>
		...
		<tr>
			<td><p style="background-color:#d4d4d4;padding:10px;color:#333333;text-align:center;font-size:13px;font-family:Calibri,Arial;">www.magicfinmart.com</p>
			</td>
		</tr>
		<tr>
			<td>&nbsp;</td>
