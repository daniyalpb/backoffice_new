...
<div class="form-group col-md-6"> 
        <div class="col-md-5">
    <select name="eprofile" id="eprofile"  class="text-primary form-control" onclick="getprofilename(this.value,document.getElementById ('PinCode').value)" value="<?php echo e($val->Profile); ?>" >
