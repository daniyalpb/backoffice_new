...
<div class="table-responsive col-md-12">
  ...
  @foreach($Hierarchy as $val)
   ...
   @endforeach
   @endisset
   @if(Session::get('usergroup')=='13'||Session::get('usergroup')=='50'||Session::get('usergroup')=='51'||Session::get('usergroup')=='70')
      ...
      <div class="modal-body">
        <form name="update_mobile_two" id="update_mobile_two">
         ...
         <div class="form-group">
          ...
          <input type="text" class="recipient-name form-control" id="mobiletwo" name="mobiletwo" required="required" onkeypress="return isNumber(event)"/>
        </div>
      </form>
