...
<script type="text/javascript">
 $(document).ready(function() {
  ...
  function getnotification() {
     $.ajax({
             url: '<?php echo e(url('web-notification')); ?>',
             type: "GET",             
             ...
             {      
              ...
              if (count=='0') {
                $("#notify").append("<li style='padding-left:20px;'>There Is No Alerts Avaliable For You</li><li style='padding-left:20px;'><a href='<?php echo e(url('My-alerts')); ?>'>View All</a></li>");
              }
              $("#divcnt").append('('+count+')');
...
function updateisread(notid){
  $.ajax({
             url: '<?php echo e(url('update-is-read')); ?>/'+notid,
             type: "GET",             
             success:function(data) 
             {     
              window.location='<?php echo e(url('My-alerts')); ?>';
             }
         });
}
...
function checkusersat() {
  $.ajax({
             url: '<?php echo e(url('Check-user-sat')); ?>',
             type: "GET",             
             success:function(data) 
             {     
              //alert('test');
...
<div class="col-md-1 col-xs-2 no-mob-pad">
	<a href="<?php echo e(url('log-out')); ?>" class="pull-right log-btn"><span class="logout-btn"><img src="<?php echo e(url('images/icon/exit.png')); ?>"></span></a>
</div>
