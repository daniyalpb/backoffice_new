    ...
    <div class="form-group col-md-6">
      ...
      <div class="col-md-7">
        <select name="eprofile" id="eprofile"  class="text-primary form-control">
          @if($data[0]->Profile == 'Admin' || $data[0]->Profile == 'Super_Admin')
            <option selected="selected" value="{{$data[0]->Profile}}">{{$data[0]->Profile}}</option>
          @else
             <option selected="selected" value="{{$data[0]->Profile}}">{{$data[0]->Profile}}</option>
...
<div class="form-group col-md-6">
  ...
  <div class="col-md-7">
    <select name="edesignation" id="edesignation" class="text-primary form-control">
        @if($data[0]->Designation == 'Admin' || $data[0]->Designation == 'Super Admin')
            <option selected="selected" value="{{$data[0]->Designation}}">{{$data[0]->Designation}}</option>
          @else
             <option selected="selected" value="{{$data[0]->Designation}}">{{$data[0]->Designation}}</option>
...
<div class="form-group col-md-6">
  ...
  <div class="col-md-7">
    <select name="tlname" id="tlname" class="text-primary form-control">
      ...
      @if($val->EmployeeName==$data[0]->EmployeeName){
      <option selected="selected" value="{{$val->EmployeeName}}">{{$val->EmployeeName}}</option> 
    }
    @else
...
<div class="form-group col-md-6">
  ...
  <div class="col-md-7">
    <select name="almname" id="almname" class="text-primary form-control">
      @foreach($catgoryupdtealm as $val)
      @if($val->EmployeeName==$data[0]->EmployeeName){
      <option selected="selected" value="{{$val->EmployeeName}}">{{$val->EmployeeName}}</option> 
    }
    @else
        ...
        <div class="col-md-5">
          <label>Primary Language :</label>
              ...
              <select name="emplanguage" id="emplanguage" class="text-primary form-control">
               ...
               @foreach($data as $val)
         @if($val->language==$data[0]->language){
         <option selected="selected" value="{{$val->language}}">{{$val->language}}</option>
         }else
