...
<table class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" id="tblofflinecs">
    ...
    <tbody>
      <?php if(isset($data)): ?>
    	...
    	<tr>
    		<td>
          <a data-toggle="modal" data-target="#csdetails" onclick="showdetails(<?php echo e($val->ID); ?>,this)"><?php echo e($val->ID); ?></a>          
        </td>
        ...
        <td>
          <?php if($val->CSID==''): ?>
         <a id="btncsid" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#csidupdate" onclick="updatecsid(<?php echo e($val->ID); ?>,this)">Update CSID</a>
         <?php endif; ?>
         <?php echo e($val->CSID); ?></td>
        <td> 
          <?php if($val->ERPID==''): ?>
          <a id="btnedit" class="btn btn-primary btn-sm" href="<?php echo e(url('offlinecs')); ?>?id=<?php echo e($val->ID); ?>"><span style="font-size: 15px;">Edit</span></a>
          <?php elseif($val->ismailsend!=1): ?>
            <a id="btnedit" class="btn btn-primary btn-sm" href="<?php echo e(url('offlinecs')); ?>?id=<?php echo e($val->ID); ?>"><span style="font-size: 15px;">Edit</span></a>
            <a id="btnedit" class="btn btn-primary btn-sm" onclick="Sendemail(<?php echo e($val->ID); ?>,this)" ><span class="glyphicon glyphicon-envelope" style="font-size: 15px;"></span></a> 
            <?php else: ?>
            <a id="btnedit" class="btn btn-primary btn-sm" onclick="Sendemail(<?php echo e($val->ID); ?>,this)" ><span class="glyphicon glyphicon-envelope" style="font-size: 15px;"></span></a> 
          <?php endif; ?>   
  ...
  function Sendemail($ID)
  {
   ...
   $.ajax({
             ...
             {      
              ...
              //window.location.href = '<?php echo e(url('offlinecs-dashboard')); ?>';
             }
         });
  }
...
$("#btncsidupdate" ).click(function(){
  if ($('#frmcsid').valid()){
   $.ajax({ 
   url: "<?php echo e(URL::to('offlinecs-csidupdate')); ?>",
   method:"POST",
