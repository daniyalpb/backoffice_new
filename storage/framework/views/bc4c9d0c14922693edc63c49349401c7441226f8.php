       ...
       <div class="modal-body">
        ...
        <table id="" class="table table-responsive table-hover" cellspacing="0">
		   <tbody>
				...
				<tr align="left">
		       <td>
					   <input required="yes" id="chkproductname" type="checkbox" name="txtproduct" class="chkproductname" value="<?php echo e($val->Product_Id); ?>"><span><?php echo e($val->Product_Name); ?></span>
					</td>
				</tr>
			 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			 </tbody>					 
           ...
           <div class="form-group">
              ...
              <option value="<?php echo e($val->id); ?>" required="yes"><?php echo e($val->status_name); ?></option>
              <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            </select>
           </div>
           <div class="form-group">
