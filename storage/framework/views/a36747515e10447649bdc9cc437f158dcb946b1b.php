...
$('#state').on('change',function(){
  ...
  $.ajax({
      type : 'post',
      url : '<?php echo e(URL::to('/get_statewise_training_cities')); ?>',
      data : formdata,
      contentType :false,
      processData : false,
...
$("#btn_submit").on('click',function(evt){
  ...
  $.ajax({
    type : 'post',
    url : '<?php echo e(URL::to('/validate_assign_training_to_fba')); ?>',
    data : formdata,
    contentType :false,
    processData : false,
    success : function(response){
...
$("#btn_assign_fba").on('click',function(){
  ...
  $.ajax({
    type : 'post',
    url : '<?php echo e(URL::to('/validate_training_fba_list')); ?>',
    data : formdata,
    processData : false,
    contentType : false,
    success : function(response){
