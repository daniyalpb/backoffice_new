 ...
 <div class="overflow-scroll">
   ...
   <tbody>
     ...
     <tr>
      ...
      <td><a onclick="updatecs({{$val->PkId}})">Update CS.No And View Doc.</a></td>
        ...
        style="width: 870px;height:550px;margin-top: 15px"></iframe>
              ...
              <!-- <div class="form-group">
               ...
               --><div class="form-group" id="divticket" style="display: none;">
                ...
                <a href="{{'RaiseaTicket'}}" class="btn btn-primary">ADD TICKET</a>
              </div>       </div>      
      <!-- Modal footer -->
...
<!-- Modal -->
  ...
  function update_cs_no(){
    ...
    $.ajax({
      ...
      type : 'POST',
      url : '{{url("update-status-offline-quotes")}}',
      data : formdata,
      contentType : false,
      processData : false,
...
<script type="text/javascript">
  ...
  $("#ncaimagefile").attr('src','{{url('/upload/offlinecs')}}/'+ $("#" + this_id).attr('data-imagepath'));
