...
<?php } else { ?>
<a href="<?php echo e(url('upload/Raiserticket')); ?>/<?php echo e($val->DocPath); ?>" download class="btn btn-primary">View</a></td>
 <?php }?> 
<td><?php echo $val->FullName ; ?></td>
<td><?php echo $val->MobiNumb1;?></td>
<td><?php echo $val->CreatedDate ; ?></td>
<td><?php echo $val->StatusName;?></td>
<td><a class="btn btn-primary" onclick="deleteticket(<?php echo e($val->TicketRequestId); ?>,this)">Delete</a>
</td>
</tr>
