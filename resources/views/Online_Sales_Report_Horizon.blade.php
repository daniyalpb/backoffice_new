...
@endif
<form name="mis_system_update" id="mis_system_update" enctype="multipart/form-data" method="POST" action="{{url('gethorizonsalesdata')}}">  
{{ csrf_field() }}      
		...
		<div class="panel panel-primary">
	      ...
	      <div class="panel-body">
	      	<div class="row">
		      	...
		      	<div class="col-md-3">
		      		<a href="{{URL::to("upload/horizonsalsedata.xlsx")}}" class="btn btn-primary" target="_blank">Download File Format</a>		      		
		      	</div>
		    </div>		 
