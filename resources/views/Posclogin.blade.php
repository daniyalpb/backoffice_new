			...
			<div class="login-bdy">
				...
				<form action="{{url('Log-in')}}" method="post" >
					...
					<div class="form-group">
						<input type="text" name="txtusername"  class="form-control input-cs" placeholder="Email"  />
						@if ($errors->has('email'))<label class="control-label" for="inputError"> {{ $errors->first('email') }}</label>  @endif
					</div>
					<div class="form-group">
						<input type="password" name="txtpassword" class="form-control input-cs" placeholder="Password"  />
					...
					<input type="Submit" class="btn btn-default submit-btn" value="SIGN IN"/>
