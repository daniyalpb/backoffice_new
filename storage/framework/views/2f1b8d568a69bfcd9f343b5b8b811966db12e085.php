  ...
  <div class="col-md-12">
   <div class="overflow-scroll">
     <div class="table-responsive" >
       ...
       <p /><p /><p />
       <span style="font-size:22; margin-left: 10px; color:#228B22">My Leads</span>
       ...
       <tbody>
        ...
        <tr  <?php if($val->EntryType=='From Contacts'): ?> style="background-color:#18e850" <?php else: ?> style="" <?php endif; ?>
          > 
