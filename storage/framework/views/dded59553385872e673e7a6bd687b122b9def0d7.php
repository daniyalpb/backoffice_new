...
<div class="col-md-12">
			 ...
			 <table id="fieldsales-details-id" class="table table-bordered table-striped tbl" >
                ...
                <tbody>
                  <?php if(isset($stateheaddta)): ?>
  <?php $__currentLoopData = $stateheaddta; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
