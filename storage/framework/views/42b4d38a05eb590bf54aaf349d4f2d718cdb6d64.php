  ...
  <script type="text/javascript" src="<?php echo e(url('js/query_script.js')); ?>"></script>
  <script src="<?php echo e(url('stylesheets/table/vendor/metisMenu/metisMenu.min.js')); ?>"></script>
