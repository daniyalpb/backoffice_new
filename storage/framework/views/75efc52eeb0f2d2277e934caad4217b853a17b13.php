...
<a href="<?php echo e(url('my-followup')); ?>" class="btn btn-success">My-Followup</a>
<a  href="<?php echo e(url('assign-followup')); ?>" class="btn btn-warning">Assign-Followup</a>
  ...
  <table id="tbluserrole" class="table table-bordered table-striped tbl" >
   ...
   <tbody>
     ...
     <?php $__currentLoopData = $query; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
          <td><a href="<?php echo e(url('crm-disposition')); ?>/<?php echo e($val->ID); ?>"><?php echo e($val->ID); ?></a></td> 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form id="CRM_Disposition_from"><?php echo e(csrf_field()); ?>
...
//               window.location="<?php echo e(url('user-role')); ?>";
