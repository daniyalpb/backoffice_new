...
function insertfsm() {
  ...
  if ($('#fsmregister').valid()){
   $.ajax({ 
   url: "<?php echo e(URL::to('Fsm-Register')); ?>",
   method:"POST",
...
$('.message_sms_id').click(function(){
  ...
  //console.log($('#message_sms_from').serialize());
   $.ajax({ 
   url: "<?php echo e(URL::to('send-fba-sms')); ?>",
   method:"POST",
...
alert(JSON.stringify(data));*/
  ...
  /* console.log($('#fbadocupload').serialize());*/
   ...
   url: "<?php echo e(URL::to('fba-listdocument')); ?>",
   method:"POST",
...
<!-- <script type="text/javascript">
   $.ajax({ 
   url: "<?php echo e(URL::to('sales-material-company')); ?>",
   method:"GET",
   success: function(datas)  
   {
...
$(document).ready(function(){
 ...
 $.ajax({
  url: "<?php echo e(url('search-state')); ?>",
  dataType: "json",
  data: { },
  success: function(data) {
...
$(document).on('change', '#search_state', function() {   
 ...
 $.ajax({
  url: "<?php echo e(url('search-city')); ?>",
  dataType: "json",
  data: {
    fstate_id : fstate_id,
  },
...
<script type="text/javascript">
  $('#sales_update').click(function(){
    ...
    else 
    {
      $.ajax({  
         type: "POST",  
         url: "<?php echo e(URL::to('../sales-update')); ?>",
  ...
  //  $('.updateLoan').show();
   // $('.modal-backdrop').show();    
    ...
    else 
    {
      $.ajax({  
         type: "POST",  
         url: "<?php echo e(URL::to('loan-update')); ?>",
...
// alert($(this).closest('tr').find('input[type=text]').val());
    ...
    else 
    {
      $.ajax({  
         type: "POST",  
         url: "<?php echo e(URL::to('posp-update')); ?>",
...
$.ajax({  
         type: "GET",  
         url:'Fsm-Details/'+smid,//"<?php echo e(URL::to('Fsm-Details')); ?>",
...
$.ajax({  
         type: "GET",  
         url:'../fba-list/'+fbaid,//"<?php echo e(URL::to('Fsm-Details')); ?>",
         success: function(fsmmsg){
...
$.ajax({  
         type: "GET",  
         url:'assign-rm-load/'+flag+'/'+val,//"<?php echo e(URL::to('Fsm-Details')); ?>",
         success: function(msg){
...
// });
 ...
 /*$.ajax({  
         type: "POST",  
         url: "<?php echo e(URL::to('assign-rm-update')); ?>",
         data : $('#assignrm').serialize(),
         success: function(msg){
...
console.log($('#rmfolloupdetails').serialize());
   $.ajax({ 
   url: "<?php echo e(URL::to('Rmfollowup')); ?>",
   method:"POST",
...
console.log($('#frmsmstemplate').serialize());
   $.ajax({ 
   url: "<?php echo e(URL::to('sms_template')); ?>",
   method:"POST",
...
if( $('#productfolloupdetails').valid())
  ...
  console.log($('#productfolloupdetails').serialize());
   $.ajax({ 
   url: "<?php echo e(URL::to('Product-followup')); ?>",
   method:"POST",
...
$.ajax({  
         ...
         url:'../fbalist-document/'+fbaid,//"<?php echo e(URL::to('Fsm-Details')); ?>",
         success: function(fsmmsg){
