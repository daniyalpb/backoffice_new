...
<form id="addnewemp" name="addnewemp" method="POST" action="<?php echo e(url('add-new-emp')); ?>">
...
<div class="col-md-7">
 <select  class="form-control select-sty " name="selecttl" id="selecttl">
        ...
        <div class="form-group col-md-6" id="cluster_hide">
          <div class="col-md-5">
           <label>Select Cluster Head/TL:</label>
         </div>
         <div class="col-md-7">
          <select name="clusterhead" id="clusterhead" class="text-primary form-control" required="">
            <option value="">--Select Cluster Head --</option>
            <?php $__currentLoopData = $cluster_Head_add; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="form-group col-md-6" id="state_hide">
       ...
       <div class="col-md-7">
        <select name="statehead" id="statehead" class="text-primary form-control" required="">
          ...
          <?php $__currentLoopData = $state_head_add; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="form-group col-md-6" id="zonal_hide">
     ...
     <div class="col-md-7">
      <select name="zonalhead" id="zonalhead" class="text-primary form-control" required="">
        ...
        <?php $__currentLoopData = $zonal_head_add; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
 ...
 -->
        ...
        <div class="form-group col-md-6 ">
          ...
          <div class="col-md-7">
             ...
             <ul class="dropdown-menu" style="min-width: 24rem; height: 152px;margin-left: 15px; overflow: auto;">
               <?php $__currentLoopData = $empsource; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="form-group col-md-6">
       ...
       <div class="form-group col-md-6">
        ...
        <?php $__currentLoopData = $catgoryupdtetladd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option value="<?php echo e($val->empname); ?>"><?php echo e($val->empname); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
      </div>
  </div>
 ...
 <!--  <div class="form-group col-md-6">
        ...
        <select name="estatus" id="estatus" class="text-primary form-control" required="">
          <option value="">--Select-Campion Source--</option>
           <?php $__currentLoopData = $empsource; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($val->Source_name); ?>"><?php echo e($val->Source_name); ?></option>
             <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </select>
          </div>
        </div> -->
