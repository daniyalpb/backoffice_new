...
?>
<input type='hidden' name='hidden_training_id' id='hidden_training_id' value='{{ $training_id }}' readonly='readonly'>
<?php
}
?>
...
<div class="container-fluid">
    ...
    <div class="panel panel-primary">
        <div class="panel-heading"><b>{{ ucfirst($mode) }} Training Schedule</b></div>
            ...
            <div class="col-md-4">
             <div class="col-md-4 no-padding">
              ...
              <select name="start_time_hour" id="start_time_hour" class="form-control">
                <option value="">Hour</option>
                  @for ($i = 1; $i <= 12; $i++)
                    <option <?php if($hour_value == $i){echo 'selected';}?> value="{{ $i }}">{{ $i }}</option>
                  @endfor
              </select>
              <span class="error_class" id="err_start_time_hour"></span>
              </div>
              ...
              <select name="start_time_minutes" id="start_time_minutes" class="form-control" >
                <option value="">Minutes</option>
                  @for ($i = 0; $i <= 59; $i+=15)
                    <option <?php if($min_value == str_pad($i,2,'0',STR_PAD_LEFT)){echo 'selected';}?> value="{{ str_pad($i,2,'0',STR_PAD_LEFT) }}">{{ str_pad($i,2,'0',STR_PAD_LEFT) }}</option>
                  @endfor
              </select>
              @endif
        ...
        <div class="row">
            ...
            <div class="col-md-2">
              <label>SMS/Email Content {{-- <sup class="compulsory_asterick">*</sup> --}}</label>
            </div>
            <div class="col-md-4">
        ...
        <div class="row">
            <div class="col-md-4 col-xs-12 col-md-offset-5">
              <input type="button" name="btn_submit" id="btn_submit" value="{{ ucfirst($mode) }}" class="btn btn-primary"> 
            </div>
        </div>
...
$("#btn_submit").on('click',function(evt){
  ...
  $.ajax({
    type : 'post',
    url : '{{ URL::to("validate-schedule-training/$mode") }}',
    data : formdata,
    processData : false,
    contentType : false,
