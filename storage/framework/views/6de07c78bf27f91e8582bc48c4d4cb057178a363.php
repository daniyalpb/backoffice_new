...
<div class="col-md-12">
  <div class="overflow-scroll">
     ...
     <tbody> 
       <tr>
         ...
         <td><?php echo e($data->EMaiID); ?></td>
          <td><?php echo e($data->MobiNumb1); ?></td>
        <!--  <td>
    ...
    <tr>
      ...
      <td><a href="" data-toggle="modal" data-target="#partnerInfo"onclick="getpartnerinfo('<?php echo e($data->fbaid); ?>')">partner info</a>
        ...
        <a href="" data-toggle="modal" data-target="#referer_code_update"onclick="Gettype2('<?php echo e($data->fbaid); ?>',this)">Update Ref.By.Code</a>
            <?php else: ?>
  ...
  <a id="type<?php echo e($data->fbaid); ?>" data-toggle="modal" onclick="Gettype('<?php echo e($data->fbaid); ?>',this)" data-target="#appsourcemodel">Update</a>
  <?php else: ?>
  ...
  <tr>
   ...
   <td>
   	<?php if($data->isactive=='isactive'): ?>
     <a href="" style="" data-toggle="modal"  data-target="#activefbamodel" onclick="Gettype('<?php echo e($data->fbaid); ?>')">update</a>
     <?php else: ?>

     <a href="" style="" data-toggle="modal"  data-target="#activefbamodel" onclick="Gettype('<?php echo e($data->fbaid); ?>')"><?php echo e($data->isactive); ?></a>      
     <?php endif; ?>
   </td>
     <td><?php if($data->POSPNo==''): ?>
   <span></span> 
   <?php else: ?>
  ...
  <td><a href="<?php echo e(url('fba-transection-history')); ?>/<?php echo e($data->fbaid); ?>" target="_blank">Transaction History</a>
  </td>
...
<div class="table-responsive col-md-12">
  ...
  <?php $__currentLoopData = $Hierarchy; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr>
        ...
        <td><?php echo e($val->recruitertluid); ?></td>
    ...
    <div class="modal-content">
      ...
      <tr>
        ...
        <option value="">--NO Recruiter TL--</option>
         <?php $__currentLoopData = $recruitertluid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <option <?php echo e($val->selected_status); ?> value="<?php echo e($val->UId); ?>"><?php echo e($val->EmployeeName); ?></option>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>
        </td>
