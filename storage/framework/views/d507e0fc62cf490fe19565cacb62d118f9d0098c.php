...
<div class="container-fluid white-bg">
    <?php if(Session::get('usergroup')!='50'&&Session::get('usergroup')!='51'): ?>
...
<div class="col-md-3">
      <select id="ddlCampaign" class="form-control" onchange="getdashboarddata();">
        <?php $__currentLoopData = $Campaigndata; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
