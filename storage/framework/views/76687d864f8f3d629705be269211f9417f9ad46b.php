      ...
      <div class="panel-heading"><b>Upload Pincode Mapping</b></div>
        ...
        <div class="col-md-3 col-xs-12">
          <div class="form-group">
            <a href="<?php echo e(URL::to('crm_upload_exel/uploded-pincode-file.xls')); ?>"><button class="btn btn-success">Download XLS</button></a>
          </div>
        </div>
       <form id="upload_files" name="upload_files" enctype="multipart/form-data">
        ...
        <a href="<?php echo e(URL::to('pincode-update-table')); ?>" class="btn btn-primary">Table Show</a>
          <div class="col-md-3 col-xs-12">
            <div class="form-group">
...
$(document).ready(function(){
   ...
   $("#uplodfiless").on('click',function(evt){
    ...
    $.ajax({
      type : 'POST',
      data : formdata,
      url : "<?php echo e(URL::to('pincode-update-excel')); ?>",
      contentType : false,
      processData : false,
