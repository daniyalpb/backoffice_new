...
<div class="container-fluid white-bg">
	...
	<br>
	<br>
	<form id="addmarketing" name="addmarketing" method="post" action="{{url('Add-Marketing-Campaign-Master')}}">
    {{csrf_field()}}
	...
	@endif
		...
		<div class="row">
			 ...
			 <div class="form-group col-md-6">
			 	...
			 	<div class="col-md-10">
			 		<a href="{{url('View-Image-Marketing-Campaign')}}" target="_blank">Doc Gallery</a>
			 	</div>
			 </div>
			 <div class="form-group col-md-3">
			 </div>
