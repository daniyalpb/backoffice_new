...
<?php endif; ?>
<form name="mis_system_update" id="mis_system_update" enctype="multipart/form-data" method="POST" action="<?php echo e(url('upload-mis-data')); ?>">  
		...
		<div class="panel panel-primary">
	      ...
	      <div class="panel-body">
	      	<div class="row">
		      	...
		      	<?php if($val->fbanotavaliable!='0'): ?>
		      	<div class="col-md-3">
		      		<a href="<?php echo e(URL::to("update_state_is_fbaid")); ?>" class="btn btn-primary">Update Fbaid & stateid</a>		      		
		      	</div>
		      	<?php endif; ?>
		      	<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>		    
		      	<div class="col-md-3">
		      		<a href="<?php echo e(URL::to("upload/Report- POSP.xlsx")); ?>" class="btn btn-primary" target="_blank">Download File Format</a>		      		
		      	</div>
		    </div>		 
