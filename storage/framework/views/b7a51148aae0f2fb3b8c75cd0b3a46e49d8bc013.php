                   ...
                   <div class="table-responsive" >
                       <table class="datatable-responsive table table-striped table-bordered dt-responsive nowrap" id="example">
                          ...
                          <tbody>
                          	...
                          	<tr>
                          		<td><a onclick="getstatus(<?php echo e($val->fbaid); ?>,this)" data-toggle="modal" data-target="#myModal"><?php echo e($val->fbaid); ?></a></td>
                          		...
                          		<td><a data-toggle="modal" data-target="#historymodal" class="btn btn-primary" onclick="gethistory(<?php echo e($val->fbaid); ?>,this)">View History</a></td>
                          	</tr>
...
$("#btnsave").click(function(){ 
 if ($('#frmstatus').valid()){
   ...
   $.ajax({ 
   url: "<?php echo e(URL::to('assigned-fba-lead-new')); ?>",
   method:"POST",
